...
from backend.flow.utils.oracle.oracle_context_dataclass import AddSlaveViaCascadingContext, OracleActKwargs
...
class OracleAddSlaveViaCascadingFlow(object):
    """
    ...
    def oracle_add_slave_via_cascading_flow(self):
        ...
        for info in self.data["infos"]:
            ...
            sub_pipeline.add_act(
                ...
                kwargs=asdict(
                    DownloadMediaKwargs(
                        ...
                        exec_ip=[old_node, old_master, cluster_master],
            ...
            sub_pipeline.add_act(
                ...
                write_payload_var=AddSlaveViaCascadingContext.get_master_configs_var_name(),
            )
            ...
            sub_pipeline.add_act(
                ...
                write_payload_var=AddSlaveViaCascadingContext.get_configs_var_name(),
            )
            ...
            sub_pipeline.add_act(
                ...
                write_payload_var=AddSlaveViaCascadingContext.get_pfile_var_name(),
            )
            ...
            sub_pipeline.add_act(
                ...
                write_payload_var=AddSlaveViaCascadingContext.get_orapw_var_name(),
            )
            ...
            sub_pipeline.add_act(
                ...
                kwargs=asdict(
                    UploadFile(
                        ...
                        content_var=AddSlaveViaCascadingContext.get_pfile_var_name(),
                    )
                ),
            )
            ...
            sub_pipeline.add_act(
                ...
                kwargs=asdict(
                    UploadFile(
                        ...
                        content_var=AddSlaveViaCascadingContext.get_orapw_var_name(),
                        encoding="base64",
                    )
                ),
            )
            ...
            sub_pipeline.add_act(
                ...
                write_payload_var=AddSlaveViaCascadingContext.get_path_var_name(),
            )
            ...
            sub_pipeline.add_act(
                ...
                kwargs=asdict(
                    OracleActKwargs(
                        ...
                        bk_cloud_id=bk_cloud_id,
                        run_as_system_user=DBA_ORACLE_USER,
                        get_oracle_payload_func=OracleActPayload.get_pause_sync_payload.__name__,
                    )
                ),
            )
            ...
            sub_pipeline.add_act(
                ...
                kwargs=asdict(
                    OracleActKwargs(
                        ...
                        bk_cloud_id=bk_cloud_id,
                        run_as_system_user=DBA_ORACLE_USER,
                        get_oracle_payload_func=OracleActPayload.get_config_data_guard_payload.__name__,
                    )
                ),
            )
        ...
        oracle_pipeline.run_pipeline(init_trans_data_class=AddSlaveViaCascadingContext())
